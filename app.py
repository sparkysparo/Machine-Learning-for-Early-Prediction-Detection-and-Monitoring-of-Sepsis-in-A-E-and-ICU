...
with tab2:
    ...
    if st.session_state.patient_data_log.empty:
        ...
        # Create an interactive line chart using Plotly for each patient
        df = st.session_state.patient_data_log.copy()
        # Since Timestamp is just HH:MM:SS, treat it as categorical
...
with tab3:
    ...
    # Since the model expects scaled data, transform the sample data for SHAP
    ...
    # Generate the SHAP summary plot; capture the current figure
