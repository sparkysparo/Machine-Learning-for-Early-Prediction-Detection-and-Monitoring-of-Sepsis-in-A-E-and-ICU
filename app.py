...
with tabs[3]:
    ...
    if st.session_state.patient_data_log.empty:
      ...
      # Ensure feature names are correctly ordered to match the scaler
 expected_columns = list(scaler.feature_names_in_)  # Get feature names from scaler
X_train = st.session_state.patient_data_log[expected_columns]  # Ensure correct column order
